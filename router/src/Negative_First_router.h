...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Negative_First_router.h
/// \brief Defines class to implement Negative First routing algorithm
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#ifndef __Negative_First_router__
#define __Negative_First_router__

#include "../../core/router.h"

//////////////////////////////////////////////////////////////////////
/// \brief Class to implement Negative First routing algorithm
///
/// inherited from from class router
//////////////////////////////////////////////////////////////////////
class Negative_First_router : public router {
	public:
		/// Constructor
		Negative_First_router() { }
