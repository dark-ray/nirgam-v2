...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file Negative_First_router.cpp
/// \brief Implements Negative First routing algorithm
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#include "Negative_First_router.h"
#include "../../config/extern.h"

////////////////////////////////////////////////
/// Method that implements Negative First routing
...
////////////////////////////////////////////////
UI Negative_First_router::calc_next(UI ip_dir, ULL source_id, ULL dest_id, routing_fault_info* rfi) {
	bool set_avail[4];
	for(UI i = 0; i < 4; i++)
		set_avail[i] = false;
    int xco = id / num_cols;
...
void Negative_First_router::initialize() {
...
extern "C" {
router *maker() {
	return new Negative_First_router;
}
}
