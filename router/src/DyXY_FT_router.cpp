...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file DyXY_FT_router.cpp
/// \brief Implements DyXY_FT routing algorithm
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#include "DyXY_FT_router.h"
#include "../../config/extern.h"

////////////////////////////////////////////////
/// Method that implements DyXY_FT routing
...
////////////////////////////////////////////////
UI DyXY_FT_router::calc_next(UI ip_dir, ULL source_id, ULL dest_id, routing_fault_info* rfi) {
    ...
    if (stress_value_arr != NULL) {
        ...
        if (state.faultDir[deb_res]) {
            if (state.faultDir[choice_1])
                if (state.faultDir[choice_2]) {
                    deb_res = ND;             // route fail
                    #ifdef DEBUG_NOC
                    eventlog<<"Can't route flit from "<<source_id<<" to "<<dest_id<<endl;
                    eventlog<<(*rfi)<<endl;
                    #endif
                }
                else
...
void DyXY_FT_router::initialize() {
